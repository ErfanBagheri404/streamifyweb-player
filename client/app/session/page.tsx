  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden" style={{ background: "var(--background)", color: "var(--foreground)" }}>
      ...
      <a
        ...
        className="mb-4 inline-flex w-fit items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium transition-all hover:scale-[1.02] active:scale-[0.98]"
        style={{ background: "var(--theme-accent)", color: "var(--theme-accent-contrast)" }}
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M19.27 5.43A28.09 28.09 0 0 0 12 3C7.5 3 3.5 5 1.5 8.5l10.5 6 10.5-6A28.09 28.09 0 0 0 19.27 5.43zM5.43 19.27A28.09 28.09 0 0 0 12 21c4.5 0 8.5-2 10.5-5.5l-10.5-6-10.5 6A28.09 28.09 0 0 0 5.43 19.27z"/></svg>
        {t("session.addBot")}
      </a>
