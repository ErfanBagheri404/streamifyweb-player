  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      try {
        ...
        const response = await fetchBackendRoute("/artist", {
          searchParams: params,
          init: {
            cache: "no-store",
          },
          ...
          <div className="flex shrink-0 items-center gap-2">
            {authUser ? (
              <>
                <Link
                  href="/session"
                  className="hidden sm:flex items-center gap-2 rounded-full border border-[#5865F2]/30 bg-[#5865F2]/15 px-4 py-2 text-sm font-semibold text-[#5865F2] transition hover:bg-[#5865F2]/25 hover:border-[#5865F2]/50"
                >
              ...
              >
                {avatarUrl ? (
                  ...
                  <div className="theme-button-solid flex h-6 w-6 items-center justify-center rounded-full text-[10px] font-bold">
                    {userInitial}
                  </div>
                )}
