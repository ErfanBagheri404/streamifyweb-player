        ...
        <div className="flex items-center justify-between gap-2 sm:gap-3">
          ...
          <div className="flex shrink-0 items-center gap-2">
            {authUser ? (
              ...
              <Link
                href="/session"
                className="flex items-center gap-1.5 rounded-full border border-[#5865F2]/30 bg-[#5865F2]/15 px-3 py-1.5 text-[11px] font-semibold text-[#5865F2] transition hover:bg-[#5865F2]/25 hover:border-[#5865F2]/50 sm:text-xs"
              >
