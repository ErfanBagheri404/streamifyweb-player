        ...
        <div className="flex items-center justify-between gap-2 sm:gap-3">
          ...
          <div className="flex shrink-0 items-center gap-2">
            {authUser ? (
              ...
              <Link
                href="/session"
                className="shrink-0 flex items-center gap-2 rounded-full border border-[#5865F2]/30 bg-[#5865F2]/15 px-4 py-2 text-sm font-semibold text-[#5865F2] transition hover:bg-[#5865F2]/25 hover:border-[#5865F2]/50"
              >
